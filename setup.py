...
setup(
    ...
    scripts=["bin/address-book-cli.py"]# Расположение главного исполняемого файла.
    url='https://github.com/LisicDisma/address-book-manager', # Адрес репозитория с вашей курсовой работой.
    license='Apache-2.0',
